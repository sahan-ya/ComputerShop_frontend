...
export default function RegisterPage() {
	...
	return (
		<div className="w-full h-screen flex bg-[#f5f5f5] overflow-hidden">
			...
			<div className="hidden lg:flex w-[52%] h-full bg-[#021a54] flex-col justify-between p-12 relative overflow-hidden">
				...
				<div className="z-10">
					...
					<h1 className="text-[#f5f5f5] text-5xl xl:text-6xl font-black leading-[1.1] tracking-tight">
						Start your<br />
						<span className="text-[#ff85bb]">tech</span><br />
						journey.
					</h1>
					<p className="mt-5 text-[#f5f5f580] text-sm font-light leading-relaxed max-w-sm">
						Create your account and get access to exclusive deals, order tracking, and a personalised dashboard.
					</p>
				</div>
			...
			{/* RIGHT PANEL */}
			<div className="w-full lg:w-[48%] h-full flex items-center justify-center px-8 overflow-y-auto">
				<div className="w-full max-w-sm py-10">
					...
					{/* Card header */}
					<div className="mb-8">
						<h2 className="text-[#021a54] text-3xl font-bold tracking-tight">Create account</h2>
						<p className="text-[#021a5470] text-sm font-light mt-1">Fill in your details to get started</p>
					</div>
					...
					<button
						onClick={signup}
						disabled={loading}
						className="w-full h-[52px] bg-[#021a54] text-[#f5f5f5] rounded-xl text-sm font-medium tracking-wide hover:bg-[#0a2b6e] hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[#021a5430] active:translate-y-0 transition-all mb-3 disabled:opacity-60 disabled:cursor-not-allowed"
					>
					...
					{/* Sign in link */}
					<p className="text-center text-[#021a5470] text-sm mt-6">
						Already have an account?{" "}
						<Link to="/login" className="text-[#ff85bb] font-medium hover:text-[#021a54] transition-colors">
							Sign in
						</Link>
					</p>
